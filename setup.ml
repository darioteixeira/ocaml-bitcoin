...
(* OASIS_START *)
(* DO NOT EDIT (digest: c8d2912a6d1d18668debc9421ab998ea) *)
(*
...
let setup_t =
  {
               ...
               Flag
                 ({
                     ...
                     },
                   {
                      flag_description =
                        Some
                          "Build auxiliary library \"bitcoin_ocurl\" (implements an HTTP client using OCurl)";
                      flag_default = [(OASISExpr.EBool true, false)];
                      });
               Library
                 ({
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\246p*u\140\001\164\250\016Kz\184\213\023\245\155";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
