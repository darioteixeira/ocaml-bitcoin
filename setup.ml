...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6e0ff1c77d319fdd9f8f33e5d09991ea) *)
(*
...
let setup_t =
  {
     ...
     doc =
       [
          ("bitcoin-full-api", OCamlbuildDocPlugin.doc_build "src");
          ("bitcoin-ocamlnet-api", OCamlbuildDocPlugin.doc_build "src");
          ("bitcoin-ocsigen-api", OCamlbuildDocPlugin.doc_build "src");
          ("bitcoin-cohttp-api", OCamlbuildDocPlugin.doc_build "src");
          ("bitcoin-api", OCamlbuildDocPlugin.doc_build "src")
       ];
     ...
     clean_doc =
       [
          ("bitcoin-full-api", OCamlbuildDocPlugin.doc_clean "src");
          ("bitcoin-ocamlnet-api", OCamlbuildDocPlugin.doc_clean "src");
          ("bitcoin-ocsigen-api", OCamlbuildDocPlugin.doc_clean "src");
          ("bitcoin-cohttp-api", OCamlbuildDocPlugin.doc_clean "src");
          ("bitcoin-api", OCamlbuildDocPlugin.doc_clean "src")
       ];
     distclean = [];
     distclean_test =
       [
            ...
            [
               Flag
                 ({
                     ...
                     },
                   {
                      flag_description =
                        Some
                          "Build auxiliary library \"bitcoin_ocsigen\" (implements an HTTP client using Ocsigenserver's Ocsigen_http_client)";
               ...
               Flag
                 ({
                     ...
                     },
                   {
                      flag_description =
                        Some
                          "Build auxiliary library \"bitcoin_ocamlnet\" (implements an HTTP client using Ocamlnet's Netclient)";
                      flag_default = [(OASISExpr.EBool true, false)];
                      });
               Flag
                 ({
                     ...
                     },
                   {
                      flag_description =
                        Some
                          "Build auxiliary library \"bitcoin_cohttp\" (implements an HTTP client using Cohttp's Cohttp_lwt_unix.Client)";
                      flag_default = [(OASISExpr.EBool true, false)];
                      });
               Flag
                 ({
                     ...
                     },
                   {
                      flag_description =
                        Some
                          "Build auxiliary library \"bitcoin_cohttp\" (implements an HTTP client using OCurl's Cohttp_lwt_unix.Client)";
                      flag_default = [(OASISExpr.EBool true, false)];
                      });
               Library
                 ({
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Bitcoin_ocsigen"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "bitcoin";
                      lib_findlib_name = Some "ocsigen";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     cs_name = "bitcoin_ocamlnet";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for OCaml-bitcoin";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\189\1955\158L8f\028\139\167\224\158\254\150\168u";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
