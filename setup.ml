...
(* OASIS_START *)
(* DO NOT EDIT (digest: 11734bf8b4d8682321a00ead24319c11) *)
(*
...
(* # 21 "/home/dario/.opam/4.00.1/build/oasis.0.3.0/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
     ...
     doc =
       [
          ("bitcoin-full-api", OCamlbuildDocPlugin.doc_build "./");
          ("bitcoin-ocamlnet-api", OCamlbuildDocPlugin.doc_build "./");
          ("bitcoin-ocsigen-api", OCamlbuildDocPlugin.doc_build "./");
          ("bitcoin-api", OCamlbuildDocPlugin.doc_build "./")
       ];
     ...
     clean_doc =
       [
          ("bitcoin-full-api", OCamlbuildDocPlugin.doc_clean "./");
          ("bitcoin-ocamlnet-api", OCamlbuildDocPlugin.doc_clean "./");
          ("bitcoin-ocsigen-api", OCamlbuildDocPlugin.doc_clean "./");
          ("bitcoin-api", OCamlbuildDocPlugin.doc_clean "./")
       ];
     distclean = [];
     distclean_test =
       [
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "bitcoin_ocamlnet"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamldoc"];
                      bs_c_sources = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\ty{\016\207C\233)\211\183_\222\164b\172\014";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
