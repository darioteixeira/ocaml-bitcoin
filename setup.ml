...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1263037d7ab4824d89e180f2f67e1b36) *)
(*
...
(* # 21 "/home/dario/.godi312/build/apps/apps-oasis/work/oasis-0.3.0~rc6/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
     ...
     doc = [("bitcoin-api", OCamlbuildDocPlugin.doc_build "./")];
     ...
     clean_doc = [("bitcoin-api", OCamlbuildDocPlugin.doc_clean "./")];
     distclean = [];
     distclean_test =
       [
          ("main",
     ...
     oasis_digest = Some "\232`d\023\221\192\208)\241w\200?\138MW\177";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
